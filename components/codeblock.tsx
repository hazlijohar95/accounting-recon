            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: DOMPurify.sanitize(icon, {
                  ALLOWED_TAGS: ['svg', 'path', 'circle', 'rect', 'line', 'polyline', 'polygon', 'g', 'defs', 'use', 'ellipse'],
                  ALLOWED_ATTR: ['viewBox', 'd', 'fill', 'stroke', 'stroke-width', 'stroke-linecap', 'stroke-linejoin', 'cx', 'cy', 'r', 'rx', 'ry', 'x', 'y', 'x1', 'y1', 'x2', 'y2', 'points', 'transform', 'class', 'id', 'href', 'xlink:href', 'width', 'height', 'xmlns'],
                }),
              }}
            />
          ) : (
