...
>((props, ref) => (
  <Unstyled.TabsList
    ...
    {...props}
    className={cn(
      // Better Auth style - clean underline tabs
...
>((props, ref) => (
  <Unstyled.TabsTrigger
    ...
    {...props}
    className={cn(
      // Better Auth style - clean with bottom border indicator
...
export function Tabs({
  ...
  return (
    <Unstyled.Tabs
      ref={ref}
      className={cn(
        // Better Auth style - clean bordered container
        'flex flex-col overflow-hidden rounded-lg border border-border my-4',
        'bg-card',
        className,
      )}
      value={value}
    ...
    >
      {items && (
        <TabsList>
          {label && <span className="text-sm font-medium my-auto me-auto px-2">{label}</span>}
          {items.map((item) => (
...
export function TabsContent({
  ...
  return (
    <Unstyled.TabsContent
      ...
      forceMount
      className={cn(
        // Better Auth style - clean content area
        'p-4 text-sm bg-card',
        'outline-none prose-no-margin',
