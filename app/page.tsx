    ...
    <div className="relative h-screen w-screen overflow-hidden flex flex-col bg-background">
        ...
        <div className="w-full max-w-3xl space-y-8">
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
              <div>
                <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60 font-mono">Start here</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-5 pt-5 border-t border-border/30">
              {[
                ...
                <div key={item.step} className="flex items-center gap-2 px-2 py-1.5">
                  <span className="text-[9px] font-mono text-muted-foreground/50">{item.step}</span>
          ...
          <div>
            <p
              className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground/50 font-mono mb-4 animate-blur-fade-in"
      ...
      <footer className="relative z-10 py-5 md:py-6 flex flex-col items-center justify-center gap-3 pb-safe px-4">
        ...
        >
          <Link
            href="/terms"
            className="text-[10px] md:text-xs text-muted-foreground/50 hover:text-muted-foreground/80 transition-colors font-mono tracking-wide focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
            Terms
          </Link>
          <Link
        ...
        {/* Copyright */}
        <p
          className="text-[10px] md:text-xs text-muted-foreground/50 font-mono tracking-wide animate-blur-fade-in"
